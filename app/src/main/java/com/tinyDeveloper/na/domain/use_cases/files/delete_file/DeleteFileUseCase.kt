package com.tinyDeveloper.na.domain.use_cases.files.delete_file
...
class DeleteFileUseCase(private val repository: Repository) {
    suspend operator fun invoke(advanceRequest: AdvanceRequest): Resource<BasicResponse>{
        return repository.deleteFile(advanceRequest = advanceRequest)
    }
}