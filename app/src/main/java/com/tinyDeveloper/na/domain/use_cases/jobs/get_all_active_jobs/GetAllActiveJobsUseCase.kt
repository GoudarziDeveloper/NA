package com.tinyDeveloper.na.domain.use_cases.jobs.get_all_active_jobs
...
class GetAllActiveJobsUseCase(private val repository: Repository) {
    suspend operator fun invoke(basicRequest: BasicRequest): Resource<GetAllJobsResponse> {
        return repository.getAllJobs(url = Constants.GET_ALL_WORKED_JOBS, basicRequest = basicRequest)
    }
}